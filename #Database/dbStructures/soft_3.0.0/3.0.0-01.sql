...
CREATE TABLE pacjent (
    ...
    wpis_data_dodania DATETIME DEFAULT GETDATE(),
    wpis_data_aktualizacji DATETIME DEFAULT GETDATE(),
...
CREATE TABLE wizyta (
    ...
    data_rezerwacji_wizyty DATETIME NOT NULL,
    data_anulowania_wizyty DATETIME NOT NULL,
